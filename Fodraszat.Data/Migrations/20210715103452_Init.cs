        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    SzuletesiIdo = table.Column<DateTime>(type: "datetime2", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Id = table.Column<int>(type: "int", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    Mettol = table.Column<DateTime>(type: "datetime2", nullable: false),
                    Hossz = table.Column<long>(type: "bigint", nullable: false),
                    Megjegyzes = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    ModositasDatum = table.Column<DateTime>(type: "datetime2", nullable: false),
                    LetrehozasDatum = table.Column<DateTime>(type: "datetime2", nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_Nyitvatartas", x => x.Id);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Idotartam = table.Column<long>(type: "bigint", nullable: false),
                    Megjegyzes = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    ModositasDatum = table.Column<DateTime>(type: "datetime2", nullable: false),
                    LetrehozasDatum = table.Column<DateTime>(type: "datetime2", nullable: false)
                },
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Idopontok_AspNetUsers_FelhasznaloId",
                        column: x => x.FelhasznaloId,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.NoAction);
                    table.ForeignKey(
                        name: "FK_Idopontok_AspNetUsers_FodraszId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Idopontok_FelhasznaloId",
                table: "Idopontok",
